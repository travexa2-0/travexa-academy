...
// Floating WhatsApp button. Extracted from the copy inlined across public
// pages (Catalog, VivencialCatalog, CourseDetail…) so new pages reuse it
// instead of duplicating it once more (Regla #1).
